...
export default class AcademiaBusiness {
    async index() {}
    async cadastroAcadamia(enderecos: Enderecos, telefones: Telefones, emails: Emails, academia: Academias) {
        return await cadastrarAcademiasRepository(academia, enderecos, emails, telefones);
    }
}
